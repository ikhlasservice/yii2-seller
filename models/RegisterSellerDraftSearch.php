...
/**
 * RegisterSellerDraftSearch represents the model behind the search form about `ikhlas\seller\models\RegisterSeller`.
 */
class RegisterSellerDraftSearch extends RegisterSeller
{
    /**
     * @inheritdoc
     */
